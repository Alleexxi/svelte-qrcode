...
interface Options {
	...
	logoWidth?: number; // Width of the logo in percentage relative to the QR code width
	logoHeight?: number; // Height of the logo in percentage relative to the QR code height
}
